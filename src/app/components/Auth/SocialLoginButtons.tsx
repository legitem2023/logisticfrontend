...
className={w-full flex items-center justify-center gap-2 px-4 py-2 bg-[#1877F2] text-white rounded-lg ${   isSdkReady ? "hover:bg-[#166FE5]" : "opacity-70 cursor-not-allowed"   } disabled:opacity-50}
>
<FaFacebook />
<span>
