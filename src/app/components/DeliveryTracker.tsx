...
const DeliveryTracker = () => {
  ...
  return (
    <div className="w-full max-w-6xl mx-auto bg-white mt-5 shadow-lg min-h-screen">
      {/* Carousel Section */}
      ...
      {/* Tracking Section */}
      <div className="w-full mx-auto p-0 relative z-10 mt-1">
        <div className="customgrad p-8 mx-auto w-full">
          ...
          <form onSubmit={handleSearch} className="flex flex-col sm:flex-row gap-4 mb-8">
            ...
            <button
              type="submit"
              className="bg-green-800 hover:bg-green-900 text-white font-medium py-4 px-10 rounded-lg flex items-center justify-center min-w-[160px] text-lg"
            >
      ...
      {/* Stats Section */}
      <div className="customgrad text-white py-16">
        <div className="container mx-auto px-4">
