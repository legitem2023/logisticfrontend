...
export default function Transactions() {
  ...
  return (
    <>
      ...
      >
        <div className="absolute bottom-0 left-0 w-full h-[85vh] bg-white rounded-t-2xl border-t shadow-t-lg flex flex-col">
          {/* Header */}
          ...
          <div className="flex-1 overflow-y-auto">
            {selectedDelivery && (
              <div className="relative bg-gradient-to-br from-white to-blue-50 min-h-full">
                ...
                <div className="p-6 border-b border-blue-200 bg-gradient-to-r from-white to-blue-50">
