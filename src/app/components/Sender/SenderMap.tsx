...
export default function SenderMap({ riderId, receiverPOS, senderPOS, riderPOS }: { riderId: any, receiverPOS: Coordinates, senderPOS: Coordinates, riderPOS: Coordinates }) {
  ...
  // Premium marker icons with luxury styling
  const riderIcon = L.divIcon({
    html: `
      <div class="luxury-marker rider-marker">
        <div class="marker-pulse"></div>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="${COLORS.gold}" width="28px" height="28px">
  ...
  useEffect(() => {
    ...
    import('leaflet-routing-machine').then(() => {
      ...
      const routingControl = L.Routing.control({
        ...
        lineOptions: {
          styles: [
            { color: COLORS.gold, opacity: 0.8, weight: 5 },
            { color: COLORS.gold, opacity: 0.3, weight: 9 }
          ],
        ...
        <div className="flex justify-between items-center">
          <div className="flex items-center">
            <div className="luxury-logo mr-3">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill={COLORS.gold} width="24px" height="24px">
        ...
        <div className="luxury-panel">
          ...
          <div className="flex items-center mb-6">
            ...
            <div className="ml-4">
              ...
              <div className="flex items-center mt-1">
                <div className="flex">
                  {[...Array(5)].map((_, i) => (
                    <svg key={i} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill={i < 4 ? COLORS.gold : COLORS.gray} width="14px" height="14px">
                      <path d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z"/>
                    </svg>
                  ))}
                </div>
                <span className="text-xs text-gray-400 ml-2">{riderInfo.rating}</span>
              </div>
            </div>
            <div className="ml-auto bg-black bg-opacity-30 rounded-lg px-3 py-2">
              <span className="text-gold-accent text-sm">{riderInfo.vehicle}</span>
            </div>
          </div>
          ...
          <div className="flex justify-between items-center mt-6">
            <div className="text-center">
              ...
              <div className="text-gold-accent font-serif text-xl">{estimatedTime}</div>
            </div>
