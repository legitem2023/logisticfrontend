...
// SUV component (replacing Car)
function EmojioneSportUtilityVehicle({ color = "#42ade2", ...props }: SVGProps<SVGSVGElement> & { color?: string }) {
  return (
    <svg 
      ...
      viewBox="0 0 64 64" 
      {...props}
      style={{ transform: 'scaleX(-1)', ...props.style }} // Flip horizontally
    >
      <path fill="#1a1a1a" d="M61.2 41.1c.1.5-.2 1-.6 1.1l-2.1.4l-2.1-12.2l1.8-.2c.5-.1 1 .2 1.1.7z"></path>
      <path fill={color} d="M56.3 27.7s1.3-.5 1.3-2.7H33.7c-2.1 0-4.8-.1-7.2 4.5c-2.1 3.9-5.3 8.1-5.4 8.2c-12.4 0-15.4 6.7-16.2 7.5c-1.3 1.3-.9 9.4-.9 9.4h53.6s2.6 0 2.6-4.1c-.1-4.2-3.9-22.8-3.9-22.8"></path>
      <path fill="#1a1a1a" d="M5.8 55.5c0 .5-.4.9-.9.9h-2c-.5 0-.9-.4-.9-.9v-4.6c0-.5.4-.9.9-.9h1.9c.5 0 .9.4.9.9zm33.1 0c0 .5-.4.9-.9.9H26c-.5 0-.9-.4-.9-.9v-1.8c0-.5.4-.9.9-.9h12c.5 0 .9.4.9.9zm23.1 0c0 .5-.4.9-.9.9h-1.9c-.5 0-.9-.4-.9-.9V50c0-.5.4-.9.9-.9h1.9c.5 0 .9.4.9.9z"></path>
      <path fill="#b4d7ee" d="M16.1 44.7c3.7 0 6.9 2.2 8.5 5.4c-.8-4.2-4.3-7.4-8.5-7.4s-7.7 3.2-8.5 7.4c1.6-3.3 4.8-5.4 8.5-5.4m31.8 0c3.7 0 6.8 2.2 8.4 5.4c-.7-4.2-4.2-7.4-8.4-7.4s-7.7 3.2-8.4 7.4c1.6-3.3 4.8-5.4 8.4-5.4"></path>
      <path fill="#d6eef0" d="M3.9 49.1s0-2.5.5-3c.5-.6 1.8-.8 3-.6c.9.2-.5 2.6-3.5 3.6"></path>
      <g fill="#1a1a1a">
        <path d="M41.7 38.2c0 .7.5 1.2 1.1 1.2H52c.6 0 1-.5.9-1.2l-1.6-8.6c-.1-.7-.7-1.2-1.3-1.2h-7.2c-.6 0-1.1.5-1.1 1.2zm-2.2-8.6c0-.7-.5-1.2-1.1-1.2h-6.1c-.6 0-1.3.5-1.6 1.1l-4.5 8.9c-.3.6 0 1.1.6 1.1h11.6c.6 0 1.1-.5 1.1-1.2z"></path>
        <ellipse cx={16.1} cy={53.7} rx={8.4} ry={8.3}></ellipse>
      </g>
      <ellipse cx={16.1} cy={53.7} fill="#e8e8e8" rx={4.8} ry={4.7}></ellipse>
      <path fill="#1a1a1a" d="M17.2 51.4c-.2.6-.7 1.1-1.1 1.1s-.9-.5-1.1-1.1v-.1c-.2-.6.3-1.1 1.2-1.1c.7 0 1.2.5 1 1.2m-2.6.2c.5.5.7 1.2.4 1.5c-.2.4-.9.5-1.6.4h-.1c-.7-.1-.9-.8-.4-1.6c.5-.7 1.2-.9 1.7-.3m-1.2 2.3c.7-.1 1.4 0 1.6.4s0 1.1-.4 1.5l-.1.1c-.5.5-1.2.3-1.6-.4s-.2-1.4.5-1.6m1.5 2.1c.2-.6.7-1.1 1.1-1.1s.9.5 1.1 1.1v.1c.2.6-.3 1.1-1.2 1.1c-.7.1-1.2-.5-1-1.2m2.6-.2c-.5-.5-.7-1.2-.4-1.5c.2-.4.9-.5 1.6-.4h.1c.7.1.9.8.4 1.6c-.4.7-1.1.9-1.7.3m1.2-2.3c-.7.1-1.4 0-1.6-.4s0-1.1.4-1.5l.1-.1c.5-.5 1.2-.3 1.6.4s.2 1.4-.5 1.6"></path>
      <g fill="#e8e8e8">
        <path d="m18.7 57l-1.1.6l-4.2-7.2l1.1-.6z"></path>
        <path d="M11.8 53.1h8.4v1.2h-8.4z"></path>
        <path d="m17.6 49.8l1.1.6l-4.2 7.2l-1.1-.6z"></path>
      </g>
      <ellipse cx={47.9} cy={53.7} fill="#1a1a1a" rx={8.4} ry={8.3}></ellipse>
      <ellipse cx={47.9} cy={53.7} fill="#e8e8e8" rx={4.8} ry={4.7}></ellipse>
      <path fill="#1a1a1a" d="M49.1 51.4c-.2.6-.7 1.1-1.1 1.1s-1-.5-1.2-1.1v-.1c-.2-.6.3-1.1 1.2-1.1c.8 0 1.3.5 1.1 1.2m-2.6.2c.5.5.7 1.2.4 1.5c-.2.4-.9.5-1.6.4h-.1c-.7-.1-.9-.8-.4-1.6c.4-.7 1.1-.9 1.7-.3m-1.2 2.3c.7-.1 1.4 0 1.6.4s0 1.1-.4 1.5l-.1.1c-.5.5-1.2.3-1.6-.4s-.2-1.4.5-1.6m1.5 2.1c.2-.6.7-1.1 1.1-1.1s.9.5 1.1 1.1v.1c.2.6-.3 1.1-1.2 1.1c-.7.1-1.2-.5-1-1.2m2.6-.2c-.5-.5-.7-1.2-.4-1.5c.2-.4.9-.5 1.6-.4h.1c.7.1.9.8.4 1.6c-.5.7-1.2.9-1.7.3m1.2-2.3c-.7.1-1.4 0-1.6-.4s0-1.1.4-1.5l.1-.1c.5-.5 1.2-.3 1.6.4s.2 1.4-.5 1.6"></path>
      <g fill="#e8e8e8">
        <path d="m50.6 57l-1.1.6l-4.2-7.2l1.1-.6z"></path>
        <path d="M43.7 53.1h8.4v1.2h-8.4z"></path>
        <path d="m49.5 49.8l1.1.6l-4.2 7.2l-1.1-.6z"></path>
      </g>
      <g fill="#1a1a1a">
        <path d="M37.7 21s-2.1 1-2.1 4h2.1s-.2-2.6 1.9-4zm11.9 0s2.1 1 2.1 4h-2.1s.2-2.6-1.9-4z"></path>
        <path d="M34.5 22h18.1c1.5 0 1.5-2 0-2H34.5c-1.5 0-1.5 2 0 2"></path>
      </g>
    </svg>
  );
}

// Telephone Tower component
function TelephoneTower(props: SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={32} height={32} viewBox="0 0 32 32" {...props}>
      <path fill="#666" d="M15 2h2v28h-2z"/>
      <path fill="#888" d="M10 8h12v2H10zm-2 6h16v2H8zm2 6h12v2H10z"/>
      <path fill="#aaa" d="M6 16h4v10H6zm16 0h4v10h-4z"/>
    </svg>
  );
}
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-4 left-[25%] z-10">
        <DeliveryTruck className="h-16 w-16" color={vehicleColors[0]} />
      </div>

      {/* Multiple SUVs (replacing Cars) */}
      {[10, 30, 50, 70, 85].map((left, i) => (
        <div
          ...
          style={{
            left: `${left}%`,
            animation: `scrollX ${15 + Math.random() * 10}s linear infinite`
          }}
        >
          <EmojioneSportUtilityVehicle className="h-10 w-10" color={vehicleColors[i % vehicleColors.length]} />
        </div>
      ))}
...
function DeliveryTruck({ className, color = "#FF0000", ...props }: SVGProps<SVGSVGElement> & { color?: string }) {
  return (
    <div className="relative">
      <svg
        ...
        {...props}
      >
        <path fill={color} d="M62 50.8c0-1-.8-1.9-1.9-1.9H3.9c-1 0-1.9.8-1.9 1.9v1.9c0 1 .8 1.9 1.9 1.9h56.2c1 0 1.9-.8 1.9-1.9z"></path>
...
function ParallaxStrip({
  ...
  // Generate building heights if not provided, ensuring the tallest is at maxHeightPercentage
  const buildingHeights = heights || Array.from({ length: 8 }, () => 
    Math.floor(Math.random() * (maxHeightPercentage - 30) + 30)
  );
  
  // Ensure the tallest building is exactly at maxHeightPercentage
  const maxHeight = Math.max(...buildingHeights);
  const scaledHeights = buildingHeights.map(h => 
    Math.floor((h / maxHeight) * maxHeightPercentage)
  );
...
function BuildingsRow({
  ...
  return (
    <div className="flex w-1/3 items-end gap-4 px-4">
      {heights.map((h, i) => (
        <div key={`${h}-${i}`} className="relative flex items-end">
          ...
          >
            <div className="absolute inset-0 grid grid-cols-3 gap-1 p-1">
              {Array.from({ length: Math.floor(h / 8) * 3 }).map((_, w) => (
                <div
                  key={w}
                  className={clsx(
                    "h-1.5 w-1.5",
          ...
          {hasTowers && i % 3 === 0 && (
            <div className="absolute -top-6 left-1/2 h-6 w-3 -translate-x-1/2">
              <TelephoneTower className="h-full w-full" />
            </div>
          )}
        </div>
      ))}
...
export default React.memo(CityScape);
