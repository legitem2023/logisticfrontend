...
className={cursor-pointer transition-all duration-150 ${   activeTab === tab   ? "text-blue-600 font-semibold border-l-4 border-blue-600 pl-2"   : "text-gray-500 hover:text-gray-800"   }}
>
{tab}
</li>
))}
