        ...
        <form onSubmit={handleSubmit} className="p-4 md:p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            ...
            <div>
              ...
              <div className="mb-6">
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition bg-white shadow-sm"
            ...
            <div>
              ...
              <div className="mb-6">
                ...
                <div className="border-2 border-dashed border-emerald-300 rounded-2xl p-4 text-center bg-emerald-50/30 transition hover:bg-emerald-50/50">
                  {previewUrl ? (
                      ...
                      <div className="flex flex-col items-center justify-center">
                        {isUploading ? (
                          <div className="mb-4">
                            ...
                            <p className="mt-2 font-medium text-gray-700">Uploading...</p>
                          </div>
                        ) : (
                          <>
                ...
                >
                  ...
                  <div className="flex justify-between mt-3">
                    ...
                    <button
                      ...
                      className="px-4 py-2 bg-emerald-600 hover:bg-emerald-700 rounded-lg text-white font-medium transition flex items-center shadow-md"
                    >
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="mt-8 flex flex-col sm:flex-row justify-center gap-3">
            <button
              type="button"
              onClick={resetForm}
              className="px-6 py-3 bg-gray-200 hover:bg-gray-300 text-gray-700 font-bold rounded-2xl shadow-lg transition flex items-center justify-center"
            >
            ...
            <button
              type="submit"
              disabled={useLoading}
              className="px-6 py-3 bg-gradient-to-r from-emerald-600 to-green-600 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100 disabled:hover:from-emerald-600 disabled:hover:to-green-600 text-white font-bold rounded-2xl shadow-lg transform transition hover:scale-[1.02] duration-300 flex items-center justify-center">
  {useLoading ? (
    "Loading..."
  ) : (
    <>
      ...
      Submit Proof of Delivery
          ...
          {showSuccess && (
            <div className="mt-6 bg-emerald-100 border border-emerald-400 text-emerald-700 px-4 py-3 rounded-xl relative flex items-center justify-center">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
              <span className="font-medium">Proof of delivery submitted successfully!</span>
            </div>
          )}
        </form>
      </div>
